...
import tech.petrepopescu.phoenix.exception.CompilationException;
import tech.petrepopescu.phoenix.parser.ByteCodeGeneratingFileManager;
...
public class Compiler {
    ...
    private void compile(List<JavaFileObject> javaFileObjects) {
